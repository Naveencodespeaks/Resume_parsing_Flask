...
async def extract_name(resume_text):
    try:
        ...
        # Define patterns to match different name formats
        patterns = [
            [{'POS': 'PROPN'}, {'POS': 'PROPN'}],  # Matches first name and last name
            [{'POS': 'PROPN'}, {'POS': 'PROPN'}, {'POS': 'PROPN'}],  # Matches first name, middle name, and last name
            [{'POS': 'PROPN'}, {'POS': 'PROPN'}, {'POS': 'PROPN'}, {'POS': 'PROPN'}]  # Matches first name, middle name, last name, and suffix
        ]
        ...
        # Iterate through matches and return the longest name found
        longest_name = ""
        for match_id, start, end in matches:
            span = doc[start:end]
            if len(span.text) > len(longest_name):
                longest_name = span.text
